 ...
 *         description: Error interno del servidor
 */
router.get('/cola', authenticate, async (req, res) => {
    const sucursalId = req.query.sucursal_id ? Number(req.query.sucursal_id) : undefined;
 ...
 *         description: Error interno del servidor
 */
router.get('/:id/receta', authenticate, async (req, res) => {
 ...
 *         description: Error interno del servidor
 */
router.post('/', authenticate, requireRole('ADMIN'), validate(schemaOrdenTrabajo), async (req, res) => {
 ...
 *         description: Error interno del servidor
 */
router.patch('/:id/estado', authenticate, requireRole('ADMIN'), validate(schemaOrdenTrabajoEstado), async (req, res) => {
 ...
 *         description: Error interno del servidor
 */
router.patch('/:id/iniciar', authenticate, requireRole('ADMIN'), async (req, res) => {
 ...
 *         description: Error interno del servidor
 */
router.patch('/:id/terminar', authenticate, requireRole('ADMIN'), async (req, res) => {
