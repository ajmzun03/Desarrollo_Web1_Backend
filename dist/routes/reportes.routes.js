 ...
 */
router.get('/utilidad-diaria', authenticate, requireRole('ADMIN'), async (req, res) => {
 ...
 */
router.get('/gastos-operativos', authenticate, requireRole('ADMIN'), async (req, res) => {
 ...
 */
router.get('/anulaciones', authenticate, requireRole('ADMIN'), async (req, res) => {
    const desde = req.query.desde;
    const hasta = req.query.hasta;
    const sucursalId = req.query.sucursal_id ? Number(req.query.sucursal_id) : undefined;
 ...
 */
router.get('/auditoria/movimientos', authenticate, requireRole('ADMIN'), async (req, res) => {
 ...
 */
router.get('/repartidores/disponibles', authenticate, requireRole('ADMIN', 'DESPACHADOR'), async (req, res) => {
    const sucursalId = req.query.sucursal_id ? Number(req.query.sucursal_id) : undefined;
