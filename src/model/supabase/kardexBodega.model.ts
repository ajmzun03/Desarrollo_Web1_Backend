...
import type { InsertKardexBodega, SelectKardexBodega } from "../../schemas/db.schema.js";
...
export const KardexBodegaModel: IKardexBodegaModel = {
  ...
  async getByBodegaId(bodegaId: number): Promise<SelectKardexBodega[]> {
  ...
  async getByLoteId(loteId: number): Promise<SelectKardexBodega[]> {
  ...
  async create(data: InsertKardexBodega): Promise<SelectKardexBodega> {
